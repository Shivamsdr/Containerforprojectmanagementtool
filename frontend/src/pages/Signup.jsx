...
import { ArrowLeft, User, Mail, Lock, UserPlus, Layout } from "lucide-react";
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] pt-12 pb-12">
        {/* Logo/Branding */}
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-500 font-medium mt-2 text-center">
            Join thousands of teams delivering projects with <span className="text-indigo-600 font-bold">Doer</span>
          </p>
        </div>
